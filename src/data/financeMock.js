export const financeMetrics = [
  ...
  },
  {
    ...
    value: "R$ 5.550",
    delta: "aluguel, folha e operacao",
    tone: "slate",
    trend: "down"
  },
  {
...
export const cashflowSummary = [
  ...
  { label: "Saidas", amount: "R$ 5.550", detail: "registradas" },
...
export const transactionRows = [
  ...
  {
    date: "25 Abr",
    description: "Cartao Bianca Torres",
    category: "Mensalidade",
    account: "Stone",
    amount: "R$ 279",
    type: "Entrada",
  ...
  {
    date: "24 Abr",
    description: "PIX sem identificacao",
...
export const reconciliationItems = [
  {
    ...
    description: "14 lancamentos importados, 10 conciliados automaticamente.",
    badge: "4 pendentes",
    tone: "warning"
  },
  {
    title: "Stone cartao",
    description: "6 recebimentos de cartao batidos com mensalidades do dia.",
    badge: "100% ok",
    tone: "success"
  },
  {
    title: "Pagamentos manuais",
    description: "3 baixas dependem de confirmacao antes do fechamento.",
    badge: "revisar",
    tone: "info"
  }
];
...
export const expenseBreakdown = [
  ...
  { label: "Operacao", amount: "R$ 650", share: "12%" },
